...
public class CHIntroActivity_ViewBinding implements Unbinder {
  private CHIntroActivity target;
  ...
  @UiThread
  public CHIntroActivity_ViewBinding(CHIntroActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CHIntroActivity_ViewBinding(final CHIntroActivity target, View source) {
    this.target = target;

    View view;
    view = Utils.findRequiredView(source, R.id.open_hide, "field 'img1' and method 'onOpen_Hide1'");
    target.img1 = Utils.castView(view, R.id.open_hide, "field 'img1'", ImageView.class);
    view2131296462 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onOpen_Hide1(p0);
      }
    });
    view = Utils.findRequiredView(source, R.id.content_txt1, "field 'txt1' and method 'onOpen_Hide1'");
  ...
  @CallSuper
  public void unbind() {
    CHIntroActivity target = this.target;
