...
public class mypostsAdapter extends BaseAdapter {
    ...
    public mypostsAdapter(Context context, List<Youji>uList, List<Youji>saveList,TextView cnt,Activity parentActivity){
        this.uList=uList;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View v=convertView.inflate(context,R.layout.mypost,null);
        ...
        //ImageView img=v.findViewById(R.id.post_img);
        ...
        delete_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                DeletePostRequest deleteRequest=new DeletePostRequest(post_id.toString(),user_id.getText().toString(),title.getText().toString(),responseListener);
                RequestQueue queue=Volley.newRequestQueue(parentActivity);
                queue.add(deleteRequest);
            }
        });
        Button r_btn=v.findViewById(R.id.revise_btn);
        r_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(parentActivity,"点击了修改",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("poster",user_id.getText().toString());
