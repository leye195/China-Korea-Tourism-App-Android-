...
public class KRFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_krfood);
        ...
        if(from.equals("1")) {
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(KRFoodActivity.this, text, Toast.LENGTH_SHORT).show();
                    getFoodList(text);
                }
                @Override
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                Intent intent=new Intent(KRFoodActivity.this,SearchResultActivity.class);
                ...
                if(response.isSuccessful()&&response.body()!=null){
                    if(response.code()==200){
                        ...
                        if(food_list.size()>0) {
                            ...
                            manager = new LinearLayoutManager(KRFoodActivity.this, LinearLayoutManager.VERTICAL, false);
                            recyclerView.setLayoutManager(manager);
                            recyclerView.addItemDecoration(new DividerItemDecoration(KRFoodActivity.this, DividerItemDecoration.VERTICAL));
                            FoodRecyclerAdapter foodRecyclerAdapter = new FoodRecyclerAdapter(KRFoodActivity.this, food_list);
                            foodRecyclerAdapter.setItemClickListener(new FoodRecyclerAdapter.foodItemClickListener() {
                                @Override
                                public void onClick(View v, int position) {
                                    Toast.makeText(KRFoodActivity.this, position + ":", Toast.LENGTH_SHORT).show();
                                    Intent intent=new Intent(KRFoodActivity.this,DetailfActivity.class);
