...
public class KRCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_krcity);
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Intent intent=new Intent(KRCityActivity.this,SearchResultActivity.class);
            ...
            public void onResponse(Call<CityList> call, retrofit2.Response<CityList> response) {
                if(response.isSuccessful()&&response.body()!=null){
                    if(response.code()==200){
                        ...
                        manager=new LinearLayoutManager(KRCityActivity.this,LinearLayoutManager.VERTICAL,false);
                        recyclerView.setLayoutManager(manager);
                        recyclerView.addItemDecoration(new DividerItemDecoration(KRCityActivity.this,DividerItemDecoration.VERTICAL));
                        CityRecyclerAdapter cityRecyclerAdapter=new CityRecyclerAdapter(KRCityActivity.this,city_list,savelist);
                                    ...
                                    Response.Listener<String>responseListener=new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response) {
                                            try{
                                                ...
                                                if(success){
                                                    Intent intent=new Intent(KRCityActivity.this,DetailcActivity.class);
                                                    intent.putExtra("city",city_list.get(position).getCity_name());
                                                    intent.putExtra("from","kr");
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    startActivity(intent);
                                                }else{
                                                    Toast.makeText(KRCityActivity.this,"访问失败",Toast.LENGTH_SHORT).show();
                                                }
                                            }catch (Exception e){
                                                e.printStackTrace();
                                            }
