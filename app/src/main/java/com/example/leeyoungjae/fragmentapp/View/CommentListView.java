package com.example.leeyoungjae.fragmentapp.View;
...
public class CommentListView extends AppCompatTextView {
    /**
     * 所有评论数据
     */
    ...
    private int mCommentSize=18;

    public int getTalkColor () {
        return mTalkColor;
    }

    public CommentListView setTalkColor (final int mTalkColor) {
    ...
    public CommentListView setMaxlines (final int mMaxlines) {
    ...
    public CommentListView setMoreStr (final String mMoreStr) {
    ...
    public CommentListView setTalkStr (final String mTalkStr) {
    ...
    public CommentListView setNameColor (final int mNameColor) {
    ...
    public CommentListView setCommentColor (final int mCommentColor) {
    ...
    public CommentListView setCommentSize(final int mCommentSize){
        this.mCommentSize=mCommentSize;
        return this;
    }

    public CommentListView (final Context context) {
        super (context);
    }



    public CommentListView (final Context context, final AttributeSet attrs) {
        super (context, attrs);
    }

    public CommentListView setonCommentListener (final onCommentListener mListener) {
