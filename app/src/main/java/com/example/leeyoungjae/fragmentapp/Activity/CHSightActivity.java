...
public class CHSightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chsight);
        ...
        if(from.equals("1")){
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(CHSightActivity.this,text,Toast.LENGTH_SHORT).show();
                    getSightList(text);
                }
                @Override
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                Intent intent=new Intent(CHSightActivity.this,SearchResultActivity.class);
    ...
    public void getSightList(String city){
        Call<SightList> call=sightService.getChSightList(city);
                ...
                if(response.isSuccessful()&&response.body()!=null){
                    if(response.code()==200){
                        ...
                        if(sight_list.size()>0) {
                            ...
                            manager = new LinearLayoutManager(CHSightActivity.this, LinearLayoutManager.VERTICAL, false);
                            recyclerView.setLayoutManager(manager);
                            recyclerView.addItemDecoration(new DividerItemDecoration(CHSightActivity.this, DividerItemDecoration.VERTICAL));
                            SightRecyclerAdapter sightRecyclerAdapter = new SightRecyclerAdapter(CHSightActivity.this, sight_list);
                            sightRecyclerAdapter.setItemClickListener(new SightRecyclerAdapter.sightItemClickListener() {
                                @Override
                                public void onClick(View v, int position) {
                                    Toast.makeText(CHSightActivity.this, position + ":", Toast.LENGTH_SHORT).show();
                                    Intent intent=new Intent(CHSightActivity.this,DetailsActivity.class);
